...
export default class HintPop1 extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div>
        ...
        <Popover placement="bottom" isOpen={this.state.popoverOpen} target="Popover1" toggle={this.toggle}>
          ...
          <PopoverBody className="text-info">essaye de créer des balises {'<footer>'}{'</footer>'} qui contiennent des balises {'<ul>'}{'</ul>'}, {'<li>'}{'</li>'} et {'<a>'}{'</a>'}.</PopoverBody>
        </Popover>
      </div>
    );
  }
